        ...
        <Container fluid className="p-5 my-5">
            <Row>
                <Col md={6} className="align-items-center text-center p-5 my-3">
                    ...
                    <p>Diplomas provide in-depth education and hands-on training tailored to specific healthcare 
                        professions, preparing you for real-world challenges.</p>
                    <p><b>Career Advancement:</b></p> 
                    <p>With a diploma, you'll have the qualifications and skills needed to pursue higher-level 
                        positions and take on greater responsibilities in your field.</p>
                    <p><b>Job Security:</b></p> 
                    <p>The healthcare industry is constantly growing, offering stable employment opportunities 
                        and job security for diploma holders.</p>
                    <p><b>Rewarding Work:</b></p> 
                    <p>Healthcare professions allow you to make a positive impact on the lives of others, 
                        providing care, comfort, and support to patients in need.</p>
